...
<html>
<head>
    <title>2/2 Dokończ zamówienie</title>
        ...
        <fieldset>
            <form action="AddUser" method="post">
                <div class="inputField">
                    <input name="city" type="text" id="city" placeholder="miasto">
                </div>
                <div class="inputField">
                    <input name="street" type="text" id="street" placeholder="ulica">
                </div>

                <div class="inputField">
                    <input name="postCode" type="text" id="postCode" placeholder="Kod pocztowy">
                </div>

                <div class="inputField" id="submitField">
                    <input id="submitBtn" type="submit" value="Zamawiam">
                </div>
