        ...
        <c:forEach items="${advList}" var="element">
            <li class="box grid-container__element">
                ...
                <div id="info">
                    ...
                    <div class="element" style="color:lightgoldenrodyellow"><a href="http://localhost:8090/inzynierka-1.0-SNAPSHOT/adversment?id=<c:out value="${element.id}"></c:out>" style="color: #C0D06F">Sprawdź Szczegóły</a></div>
                </div>
            </li>
        </c:forEach>
    </ul>
